...
st.set_page_config(page_title="HidroSed v3.0 Dios Supremo · Hotfix DEM", page_icon="🌊", layout="wide")
...
st.markdown(
    """
<div class='hs-hero'>
  <h1>🌊 HidroSed Maestra Integral v3.0 Hotfix DEM · Dios Supremo · Hotfix DEM</h1>
